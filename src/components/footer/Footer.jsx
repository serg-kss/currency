...
import Phone from '../utils-components/phone/Phone';
import socialWeb from '../../img/social-web.png';
        ...
        <div className={styles.footerContainer}>
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" viewBox="0 0 23 23" fill="none">
            ...
            <defs>
              ...
              <clipPath id="clip0_4342_24">
              <rect width="23" height="23" fill="white"/>
              </clipPath>
            </defs>
          </svg>
            <p className={styles.logoTitle}>Чіп Чендж</p>
          </div>
          <p className={styles.logoText}>04128, м.Київ, вул. Хрещатик, 19 Ліцензія НБУ №156 Ⓒ ПАТ ЧіпЧендж, 2019-2023</p>
        </div>
        <ul className={styles.footerContainer}>
          {props.footerLinks.map(element => <li className={styles.navigationLinks}><NavigationLink link = {element}/></li> )}
        </ul>
        <Phone phone={props.footer.phone[0]}/>
        <Phone phone={props.footer.phone[1]}/>
        <div className={styles.footerContainer}>
